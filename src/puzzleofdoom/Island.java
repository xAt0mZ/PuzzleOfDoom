...
//		DebugHelper.LogWithEnd("Island " + number);
	...
	public void crossover() {
		...
		// liste de nombres de 0 Ã  piecesCount
		...
		while (remainingToCreate > 0) {
			...
			ArrayList<Integer> remainingNumbers = (ArrayList<Integer>)remainingNumbersSave.clone();
...
//		DebugHelper.LogWithEnd("Island " + number);
	...
	public void selection() {
		...
		// Une board apparaï¿½t x fois dans le tableau
		// ou x = rating
		// ex : si b1.rating = 3 et b2.rating=2
		// tabBoard = [b1][b1][b1][b2][b2]
		// Ensuite, tant que remainingToSelect est supï¿½rieur ï¿½ 0
		// on selection au hasard une board, une fois sï¿½lectionnï¿½e,
		// toutes les occurences de la board sï¿½lectionnï¿½e sont retirï¿½es
		// du tableau
		...
		// Normalement arrivï¿½ ici la liste pour la selection de board est
...
//		DebugHelper.Log("");
	...
	{
		// Si X% des boards avec même rating = migrate
	...
	public ArrayList<Board> migrate(long nbIsland, int coeffRepartition)
	{
		...
		// nbIsland = le nombre total d'îles existantes
